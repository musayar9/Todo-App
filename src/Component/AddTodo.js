...
function AddTodo() {
    ...
    <div className="flex items-center p-10 sm:p-8 md:p-6 space-x-3 sm:space-x-6 md:space-x-8   ">
      <input className="w-72 md:w-96 outline-none border border-gray-500 p-3 text-center placeholder:text-gray-700  text-lg  md:text-xl rounded-xl" placeholder= "Add Task" value={text} onChange={(e)=>setText(e.target.value)}/>
